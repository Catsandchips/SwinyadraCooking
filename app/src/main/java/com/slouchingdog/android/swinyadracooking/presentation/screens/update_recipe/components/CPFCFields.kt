...
fun CPFCFields(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            SwinyadraTextField(
                value = if (state.calories != 0) state.calories.toString() else "",
            ...
            SwinyadraTextField(
                value = if (state.proteins != 0) state.proteins.toString() else "",
            ...
            SwinyadraTextField(
                value = if (state.fats != 0) state.fats.toString() else "",
            ...
            SwinyadraTextField(
                value = if (state.carbons != 0) state.carbons.toString() else "",
